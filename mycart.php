...
<div class="d-flex flex-grow-1 p-3 ms-auto justify-content-center text-white bg-secondary">
                <div class="row-flex">
                  ...
                  if ($num > 0) {
                    ...
                    echo "<td style='width: 130px;'>" .' $'. $row['price'] . "</td>";
                    echo "<td> <a href='api/cart/removeQty.php?id=$row[product_id]'><i class='bi bi-dash-lg text-white'></i></a></td>";
                    echo "<td class='text-center'>" . $row['qty']. "</td>";
                    echo "<td> <a href='api/cart/addQty.php?id=$row[product_id]'><i class='bi bi-plus-lg text-white'></i></a></td>";
                    echo "<td class='text-right' style='width: 100px;'>".' $' . $row['price']*$row['qty']. "</td>";
                    echo "<td class='text-center'> <a href='api/cart/deletecart.php?id=$row[product_id]'><i class='bi bi-trash3-fill text-white'></i></a></td>";
                    echo "</td>";
                    echo "</tr>";
                    $total=$total+$row['price']*$row['qty'];
                  }?>
                <tr><th>Total: <?php echo ' $' .$total;  ?></th>
<?php              
  }
                ?>
