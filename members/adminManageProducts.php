    ...
    <div class="row">
      <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark c_h" style="width:250px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <hr>
          <li><button onclick="location.reload()" type="button" class="btn-info p-2 pr-4 pl-4 m-3"><i
                class="bi bi-tags-fill p-1"></i></i>All Products</button></li>
          <li><button onclick="getOneProduct()" id="searchID" type="button" class="btn-info p-2 pr-4 pl-4 m-3"><i
          ...
          <li class="nav-item"><a class="nav-link active" href="../api/admin/admin_logout.php" aria-current="page"><i
                class="bi bi-house pr-2"></i>Log out</a></li>
        </ul>
      </div>


      <div class="d-flex flex-grow-1 py-3 ps-0 ms-0 justify-content-center text-white bg-secondary">
        <div class="row-flex">
